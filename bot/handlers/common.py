...
<b>Если подключён ИИ</b> (ключ в файле .env)
· Голосовое сообщение — наговори траты, бот запишет
· <code>в пятёрочке 2340 и кофе 300</code> — разберёт в две траты
/insight — разбор месяца словами
...
/edit <code>42 6000</code> — исправить сумму записанной траты
/export — выгрузка: PDF, CSV или JSON для ИИ
/import — залить обратно файл, который проверил ИИ
